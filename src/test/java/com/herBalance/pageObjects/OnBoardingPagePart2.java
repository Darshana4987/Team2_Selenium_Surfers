...
public class OnBoardingPagePart2 {
	...
	// delete
	private By healthCondition = By.xpath("//label[@for='hypothyroidism']");
	private By name = By.xpath("//input[@id='name']");
	private By age = By.xpath("//input[@id='age']");
	private By bloodPressureStatus = By.xpath("//span[contains(text(),\"I'm not sure\")]");
	private By btnContinueWithoutReport = By.xpath("//button[text()='Continue Without Report']");

	// Step 6

	private By progressBarCurrentStep = By.xpath("//*[contains(text(),'6 of 10')]");
	private By errormsgInvalidDate = By.xpath("//p[text()='Please select your last period start date']");
	...
	private By titleStep9 = By
			.xpath("//h2[text()='Physical Activity Level']");
	private By descriptionForStep9 = By.xpath("//p[contains(text(),'current exercise routine')]");
	private By infoForStep9 = By
			.xpath("//p[contains(text(),\"Your activity level helps us design a fitness plan\")]");
	...
	private By titleStep10 = By.xpath("//h2[text()='Food Allergies & Sensitivities']");
	private By descriptionStep10 = By.xpath("//p[contains(text(),'food allergies or intolerances')]");
	private By infoForStep10 = By.xpath("//p[contains(text(),'Food sensitivities can impact digestion')]");
	...
	public void clickMenstrualCycleAwarenessOptions() {

		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));

		WebElement yesRadio = wait.until(ExpectedConditions.elementToBeClickable(By.id("yes")));
	...
	public void clickBloodPressureStatus() {
	...
	public void enterlastMenstrualDate() {
		...
		WebElement dateInput = wait.until(ExpectedConditions.visibilityOfElementLocated(inputCalenderControl));
	...
	public boolean isFoodAllergyOptionsLabelVisible(String foodAllergyOptionLabel) {
		...
		List<WebElement> bloodPressureLabel = wait
				.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(lblFoodAllergy));
