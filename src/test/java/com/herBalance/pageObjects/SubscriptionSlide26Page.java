...
public class SubscriptionSlide26Page {
	...
	//div[@role='menuitem']/a[@href='/subscription']
		...
		private By gotoDashboardButton1Path = By.xpath(
		...
		private By gotoDashboardButton2Path = By.xpath(
			    "//h3[text()='Subscription History']/ancestor::div[contains(@class,'rounded-lg')]//a[@href='/dashboard']/button"
			);
		
		private By gotoPlansButtonPath = By.xpath(
			    "//div[contains(@class,'rounded-lg')]//a[@href='/plans']/button"
			);
